...
CTEST(worksheet, lxlsx_worksheet_data_bar06) {
    ...
    conditional_format->bar_negative_color_same        = LXLSX_TRUE;
    ...
    conditional_format->bar_negative_border_color_same = LXLSX_TRUE;
