...
CTEST(worksheet, write_sheet_views02) {
    ...
    lxlsx_worksheet_select(worksheet);
    lxlsx_worksheet_set_zoom(worksheet, 100);
    _worksheet_write_sheet_views(worksheet);
...
CTEST(worksheet, write_sheet_views03) {
    ...
    lxlsx_worksheet_select(worksheet);
    lxlsx_worksheet_set_zoom(worksheet, 200);
    _worksheet_write_sheet_views(worksheet);
...
CTEST(worksheet, write_sheet_views04) {
    ...
    lxlsx_worksheet_select(worksheet);
    lxlsx_worksheet_right_to_left(worksheet);
    _worksheet_write_sheet_views(worksheet);
...
CTEST(worksheet, write_sheet_views05) {
    ...
    lxlsx_worksheet_select(worksheet);
    lxlsx_worksheet_hide_zero(worksheet);
    _worksheet_write_sheet_views(worksheet);
