...
CTEST(chart, write_legend02) {
    ...
    lxlsx_chart_legend_set_position(chart, LXLSX_CHART_LEGEND_RIGHT);
    _chart_write_legend(chart);
...
CTEST(chart, write_legend03) {
    ...
    lxlsx_chart_legend_set_position(chart, LXLSX_CHART_LEGEND_TOP);
    _chart_write_legend(chart);
...
CTEST(chart, write_legend04) {
    ...
    lxlsx_chart_legend_set_position(chart, LXLSX_CHART_LEGEND_LEFT);
    _chart_write_legend(chart);
...
CTEST(chart, write_legend07) {
    ...
    lxlsx_chart_legend_set_position(chart, LXLSX_CHART_LEGEND_OVERLAY_RIGHT);
    _chart_write_legend(chart);
...
CTEST(chart, write_legend08) {
    ...
    lxlsx_chart_legend_set_position(chart, LXLSX_CHART_LEGEND_OVERLAY_LEFT);
    _chart_write_legend(chart);
