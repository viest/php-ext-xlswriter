...
CTEST(worksheet, lxlsx_worksheet_condtional_format13) {
...
CTEST(worksheet, lxlsx_worksheet_condtional_format13b) {
    ...
    conditional_format->mid_rule_type  = LXLSX_CONDITIONAL_RULE_TYPE_PERCENTILE;
