...
CTEST(worksheet, lxlsx_worksheet_data_bar11) {
    ...
    conditional_format->min_rule_type                  = LXLSX_CONDITIONAL_RULE_TYPE_FORMULA;
    ...
    conditional_format->data_bar_2010                  = LXLSX_TRUE;
    conditional_format->min_rule_type                  = LXLSX_CONDITIONAL_RULE_TYPE_FORMULA;
    conditional_format->max_rule_type                  = LXLSX_CONDITIONAL_RULE_TYPE_FORMULA;
    conditional_format->min_value_string               = "=$B$1";
    ...
    conditional_format->min_rule_type                  = LXLSX_CONDITIONAL_RULE_TYPE_PERCENTILE;
    conditional_format->max_rule_type                  = LXLSX_CONDITIONAL_RULE_TYPE_PERCENTILE;
