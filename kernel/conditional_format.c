/*
  ...
  +----------------------------------------------------------------------+
  | A thin PHP veneer over libxlsxwriter's lxlsx_conditional_format struct. |
...
PHP_METHOD(vtiful_cond_format, __construct)
{
    ...
    if (!obj->ptr.cf) {
        obj->ptr.cf = ecalloc(1, sizeof(lxlsx_conditional_format));
    }
}
/* }}} */
 ...
 * Format resource (toResource()) and stash the lxlsx_format pointer. */
PHP_METHOD(vtiful_cond_format, format)
{
    zval *handle;
    lxlsx_format *fmt = NULL;
...
VTIFUL_STARTUP_FUNCTION(conditional_format)
{
    ...
    /* Type constants */
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_CELL",          LXLSX_CONDITIONAL_TYPE_CELL)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_TEXT",          LXLSX_CONDITIONAL_TYPE_TEXT)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_TIME_PERIOD",   LXLSX_CONDITIONAL_TYPE_TIME_PERIOD)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_AVERAGE",       LXLSX_CONDITIONAL_TYPE_AVERAGE)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_DUPLICATE",     LXLSX_CONDITIONAL_TYPE_DUPLICATE)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_UNIQUE",        LXLSX_CONDITIONAL_TYPE_UNIQUE)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_TOP",           LXLSX_CONDITIONAL_TYPE_TOP)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_BOTTOM",        LXLSX_CONDITIONAL_TYPE_BOTTOM)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_BLANKS",        LXLSX_CONDITIONAL_TYPE_BLANKS)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_NO_BLANKS",     LXLSX_CONDITIONAL_TYPE_NO_BLANKS)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_ERRORS",        LXLSX_CONDITIONAL_TYPE_ERRORS)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_NO_ERRORS",     LXLSX_CONDITIONAL_TYPE_NO_ERRORS)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_FORMULA",       LXLSX_CONDITIONAL_TYPE_FORMULA)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_2_COLOR_SCALE", LXLSX_CONDITIONAL_2_COLOR_SCALE)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_3_COLOR_SCALE", LXLSX_CONDITIONAL_3_COLOR_SCALE)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_DATA_BAR",      LXLSX_CONDITIONAL_DATA_BAR)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "TYPE_ICON_SETS",     LXLSX_CONDITIONAL_TYPE_ICON_SETS)

    /* Criteria constants */
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_EQUAL_TO",                 LXLSX_CONDITIONAL_CRITERIA_EQUAL_TO)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_NOT_EQUAL_TO",             LXLSX_CONDITIONAL_CRITERIA_NOT_EQUAL_TO)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_GREATER_THAN",             LXLSX_CONDITIONAL_CRITERIA_GREATER_THAN)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_LESS_THAN",                LXLSX_CONDITIONAL_CRITERIA_LESS_THAN)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_GREATER_THAN_OR_EQUAL_TO", LXLSX_CONDITIONAL_CRITERIA_GREATER_THAN_OR_EQUAL_TO)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_LESS_THAN_OR_EQUAL_TO",    LXLSX_CONDITIONAL_CRITERIA_LESS_THAN_OR_EQUAL_TO)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_BETWEEN",                  LXLSX_CONDITIONAL_CRITERIA_BETWEEN)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_NOT_BETWEEN",              LXLSX_CONDITIONAL_CRITERIA_NOT_BETWEEN)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_TEXT_CONTAINING",          LXLSX_CONDITIONAL_CRITERIA_TEXT_CONTAINING)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_TEXT_NOT_CONTAINING",      LXLSX_CONDITIONAL_CRITERIA_TEXT_NOT_CONTAINING)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_TEXT_BEGINS_WITH",         LXLSX_CONDITIONAL_CRITERIA_TEXT_BEGINS_WITH)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_TEXT_ENDS_WITH",           LXLSX_CONDITIONAL_CRITERIA_TEXT_ENDS_WITH)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_TIME_PERIOD_YESTERDAY",    LXLSX_CONDITIONAL_CRITERIA_TIME_PERIOD_YESTERDAY)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_TIME_PERIOD_TODAY",        LXLSX_CONDITIONAL_CRITERIA_TIME_PERIOD_TODAY)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_TIME_PERIOD_TOMORROW",     LXLSX_CONDITIONAL_CRITERIA_TIME_PERIOD_TOMORROW)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_TIME_PERIOD_LAST_7_DAYS",  LXLSX_CONDITIONAL_CRITERIA_TIME_PERIOD_LAST_7_DAYS)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_TIME_PERIOD_LAST_WEEK",    LXLSX_CONDITIONAL_CRITERIA_TIME_PERIOD_LAST_WEEK)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_TIME_PERIOD_THIS_WEEK",    LXLSX_CONDITIONAL_CRITERIA_TIME_PERIOD_THIS_WEEK)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_TIME_PERIOD_NEXT_WEEK",    LXLSX_CONDITIONAL_CRITERIA_TIME_PERIOD_NEXT_WEEK)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_TIME_PERIOD_LAST_MONTH",   LXLSX_CONDITIONAL_CRITERIA_TIME_PERIOD_LAST_MONTH)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_TIME_PERIOD_THIS_MONTH",   LXLSX_CONDITIONAL_CRITERIA_TIME_PERIOD_THIS_MONTH)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_TIME_PERIOD_NEXT_MONTH",   LXLSX_CONDITIONAL_CRITERIA_TIME_PERIOD_NEXT_MONTH)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_AVERAGE_ABOVE",            LXLSX_CONDITIONAL_CRITERIA_AVERAGE_ABOVE)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_AVERAGE_BELOW",            LXLSX_CONDITIONAL_CRITERIA_AVERAGE_BELOW)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "CRITERIA_TOP_OR_BOTTOM_PERCENT",    LXLSX_CONDITIONAL_CRITERIA_TOP_OR_BOTTOM_PERCENT)

    /* Rule types for color scales / data bars */
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "RULE_MINIMUM",     LXLSX_CONDITIONAL_RULE_TYPE_MINIMUM)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "RULE_NUMBER",      LXLSX_CONDITIONAL_RULE_TYPE_NUMBER)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "RULE_PERCENT",     LXLSX_CONDITIONAL_RULE_TYPE_PERCENT)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "RULE_PERCENTILE",  LXLSX_CONDITIONAL_RULE_TYPE_PERCENTILE)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "RULE_FORMULA",     LXLSX_CONDITIONAL_RULE_TYPE_FORMULA)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "RULE_MAXIMUM",     LXLSX_CONDITIONAL_RULE_TYPE_MAXIMUM)

    /* Bar direction */
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "BAR_DIRECTION_CONTEXT",         LXLSX_CONDITIONAL_BAR_DIRECTION_CONTEXT)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "BAR_DIRECTION_LEFT_TO_RIGHT",   LXLSX_CONDITIONAL_BAR_DIRECTION_LEFT_TO_RIGHT)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "BAR_DIRECTION_RIGHT_TO_LEFT",   LXLSX_CONDITIONAL_BAR_DIRECTION_RIGHT_TO_LEFT)

    /* Bar axis position */
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "BAR_AXIS_AUTOMATIC", LXLSX_CONDITIONAL_BAR_AXIS_AUTOMATIC)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "BAR_AXIS_MIDPOINT",  LXLSX_CONDITIONAL_BAR_AXIS_MIDPOINT)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "BAR_AXIS_NONE",      LXLSX_CONDITIONAL_BAR_AXIS_NONE)

    /* Icon styles */
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_3_ARROWS_COLORED", LXLSX_CONDITIONAL_ICONS_3_ARROWS_COLORED)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_3_ARROWS_GRAY",    LXLSX_CONDITIONAL_ICONS_3_ARROWS_GRAY)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_3_FLAGS",          LXLSX_CONDITIONAL_ICONS_3_FLAGS)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_3_TRAFFIC_LIGHTS_UNRIMMED", LXLSX_CONDITIONAL_ICONS_3_TRAFFIC_LIGHTS_UNRIMMED)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_3_TRAFFIC_LIGHTS_RIMMED",   LXLSX_CONDITIONAL_ICONS_3_TRAFFIC_LIGHTS_RIMMED)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_3_SIGNS",                   LXLSX_CONDITIONAL_ICONS_3_SIGNS)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_3_SYMBOLS_CIRCLED",         LXLSX_CONDITIONAL_ICONS_3_SYMBOLS_CIRCLED)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_3_SYMBOLS_UNCIRCLED",       LXLSX_CONDITIONAL_ICONS_3_SYMBOLS_UNCIRCLED)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_4_ARROWS_COLORED",          LXLSX_CONDITIONAL_ICONS_4_ARROWS_COLORED)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_4_ARROWS_GRAY",             LXLSX_CONDITIONAL_ICONS_4_ARROWS_GRAY)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_4_RED_TO_BLACK",            LXLSX_CONDITIONAL_ICONS_4_RED_TO_BLACK)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_4_RATINGS",                 LXLSX_CONDITIONAL_ICONS_4_RATINGS)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_4_TRAFFIC_LIGHTS",          LXLSX_CONDITIONAL_ICONS_4_TRAFFIC_LIGHTS)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_5_ARROWS_COLORED",          LXLSX_CONDITIONAL_ICONS_5_ARROWS_COLORED)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_5_ARROWS_GRAY",             LXLSX_CONDITIONAL_ICONS_5_ARROWS_GRAY)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_5_RATINGS",                 LXLSX_CONDITIONAL_ICONS_5_RATINGS)
    REGISTER_CLASS_CONST_LONG(vtiful_cond_format_ce, "ICONS_5_QUARTERS",                LXLSX_CONDITIONAL_ICONS_5_QUARTERS)
