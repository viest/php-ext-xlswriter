...
CTEST(worksheet, lxlsx_worksheet_condtional_format03) {
    ...
    conditional_format->type      = LXLSX_CONDITIONAL_TYPE_CELL;
    conditional_format->criteria  = LXLSX_CONDITIONAL_CRITERIA_NOT_BETWEEN;
    conditional_format->min_value = 20;
    conditional_format->max_value = 30;
...
CTEST(worksheet, lxlsx_worksheet_condtional_format03b) {
