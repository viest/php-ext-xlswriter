...
static void test_writer_output_is_readable_by_unified_reader(void)
{
    ...
    TEST_ASSERT_EQUAL_DOUBLE(123.5, cell.data.reader.value.number);
    TEST_ASSERT_GREATER_THAN(0, (int)cell.data.reader.style_ref);
    number_style_ref = cell.data.reader.style_ref;
    ...
    TEST_ASSERT_EQUAL_STRING_LEN("alpha", cell.data.reader.value.string.ptr, 5);
