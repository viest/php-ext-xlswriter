...
CTEST(worksheet, lxlsx_worksheet_condtional_format17) {
    ...
    conditional_format->mid_rule_type    = LXLSX_CONDITIONAL_RULE_TYPE_PERCENT;
...
CTEST(worksheet, lxlsx_worksheet_condtional_format17b) {
