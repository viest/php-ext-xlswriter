...
CTEST(worksheet, lxlsx_worksheet_condtional_format11) {
    ...
    lxlsx_datetime datetime1 = {2011,   1,   1, 0, 0, 0};
    lxlsx_datetime datetime2 = {2011,  12,  31, 0, 0, 0};
    ...
    conditional_format->criteria  = LXLSX_CONDITIONAL_CRITERIA_BETWEEN;
    conditional_format->min_value = lxlsx_datetime_to_excel_datetime(&datetime1);
    conditional_format->max_value = lxlsx_datetime_to_excel_datetime(&datetime2);
