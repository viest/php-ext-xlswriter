...
CTEST(worksheet, lxlsx_worksheet_condtional_format05) {
    ...
    conditional_format->type     = LXLSX_CONDITIONAL_TYPE_AVERAGE;
    conditional_format->criteria = LXLSX_CONDITIONAL_CRITERIA_AVERAGE_ABOVE;
    lxlsx_worksheet_conditional_format_range(worksheet, RANGE("A1:A4"), conditional_format);

    conditional_format->type     = LXLSX_CONDITIONAL_TYPE_AVERAGE;
    conditional_format->criteria = LXLSX_CONDITIONAL_CRITERIA_AVERAGE_BELOW;
    lxlsx_worksheet_conditional_format_range(worksheet, RANGE("A1:A4"), conditional_format);

    conditional_format->type     = LXLSX_CONDITIONAL_TYPE_AVERAGE;
    conditional_format->criteria = LXLSX_CONDITIONAL_CRITERIA_AVERAGE_ABOVE_OR_EQUAL;
    lxlsx_worksheet_conditional_format_range(worksheet, RANGE("A1:A4"), conditional_format);

    conditional_format->type     = LXLSX_CONDITIONAL_TYPE_AVERAGE;
    conditional_format->criteria = LXLSX_CONDITIONAL_CRITERIA_AVERAGE_BELOW_OR_EQUAL;
    lxlsx_worksheet_conditional_format_range(worksheet, RANGE("A1:A4"), conditional_format);

    conditional_format->type     = LXLSX_CONDITIONAL_TYPE_AVERAGE;
    conditional_format->criteria = LXLSX_CONDITIONAL_CRITERIA_AVERAGE_1_STD_DEV_ABOVE;
    lxlsx_worksheet_conditional_format_range(worksheet, RANGE("A1:A4"), conditional_format);

    conditional_format->type     = LXLSX_CONDITIONAL_TYPE_AVERAGE;
    conditional_format->criteria = LXLSX_CONDITIONAL_CRITERIA_AVERAGE_1_STD_DEV_BELOW;
    lxlsx_worksheet_conditional_format_range(worksheet, RANGE("A1:A4"), conditional_format);

    conditional_format->type     = LXLSX_CONDITIONAL_TYPE_AVERAGE;
    conditional_format->criteria = LXLSX_CONDITIONAL_CRITERIA_AVERAGE_2_STD_DEV_ABOVE;
    lxlsx_worksheet_conditional_format_range(worksheet, RANGE("A1:A4"), conditional_format);

    conditional_format->type     = LXLSX_CONDITIONAL_TYPE_AVERAGE;
    conditional_format->criteria = LXLSX_CONDITIONAL_CRITERIA_AVERAGE_2_STD_DEV_BELOW;
    lxlsx_worksheet_conditional_format_range(worksheet, RANGE("A1:A4"), conditional_format);

    conditional_format->type     = LXLSX_CONDITIONAL_TYPE_AVERAGE;
    conditional_format->criteria = LXLSX_CONDITIONAL_CRITERIA_AVERAGE_3_STD_DEV_ABOVE;
    lxlsx_worksheet_conditional_format_range(worksheet, RANGE("A1:A4"), conditional_format);

    conditional_format->type     = LXLSX_CONDITIONAL_TYPE_AVERAGE;
    conditional_format->criteria = LXLSX_CONDITIONAL_CRITERIA_AVERAGE_3_STD_DEV_BELOW;
    lxlsx_worksheet_conditional_format_range(worksheet, RANGE("A1:A4"), conditional_format);
