...
$verify->openFile('format_border_of_the_four_side_1.xlsx')->openSheet();
$sid = 0;
...
var_dump($fmt['border']['left']['style'], $fmt['border']['right']['style'],
         $fmt['border']['top']['style'],  $fmt['border']['bottom']['style']);
?>
--CLEAN--
<?php
