...
CTEST(worksheet, lxlsx_worksheet_condtional_format12) {
    ...
    conditional_format->type     = LXLSX_CONDITIONAL_2_COLOR_SCALE;
...
CTEST(worksheet, lxlsx_worksheet_condtional_format12b) {
...
CTEST(worksheet, lxlsx_worksheet_condtional_format12d) {
