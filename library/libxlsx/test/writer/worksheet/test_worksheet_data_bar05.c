...
CTEST(worksheet, lxlsx_worksheet_data_bar05) {
    ...
    conditional_format->bar_direction      = LXLSX_CONDITIONAL_BAR_DIRECTION_LEFT_TO_RIGHT;
    ...
    conditional_format->bar_direction      = LXLSX_CONDITIONAL_BAR_DIRECTION_RIGHT_TO_LEFT;
