...
CTEST(worksheet, lxlsx_worksheet_condtional_format09) {
    ...
    conditional_format->type         = LXLSX_CONDITIONAL_TYPE_BLANKS;
    lxlsx_worksheet_conditional_format_range(worksheet, RANGE("A1:A4"), conditional_format);

    conditional_format->type         = LXLSX_CONDITIONAL_TYPE_NO_BLANKS;
    lxlsx_worksheet_conditional_format_range(worksheet, RANGE("A1:A4"), conditional_format);

    conditional_format->type         = LXLSX_CONDITIONAL_TYPE_ERRORS;
    lxlsx_worksheet_conditional_format_range(worksheet, RANGE("A1:A4"), conditional_format);

    conditional_format->type         = LXLSX_CONDITIONAL_TYPE_NO_ERRORS;
    lxlsx_worksheet_conditional_format_range(worksheet, RANGE("A1:A4"), conditional_format);
