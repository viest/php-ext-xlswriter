...
CTEST(worksheet, lxlsx_worksheet_condtional_format02) {
    ...
    lxlsx_worksheet_write_number(worksheet, CELL("B1"), 5, NULL);
...
CTEST(worksheet, lxlsx_worksheet_condtional_format02b) {
