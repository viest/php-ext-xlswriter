...
CTEST(worksheet, write_split_panes02) {
    ...
    lxlsx_worksheet_select(worksheet);
    lxlsx_worksheet_split_panes(worksheet, 30, 0);
    _worksheet_write_sheet_views(worksheet);
...
CTEST(worksheet, write_split_panes03) {
    ...
    lxlsx_worksheet_select(worksheet);
    lxlsx_worksheet_split_panes(worksheet, 105, 0);
    _worksheet_write_sheet_views(worksheet);
...
CTEST(worksheet, write_split_panes05) {
    ...
    lxlsx_worksheet_select(worksheet);
    lxlsx_worksheet_split_panes(worksheet, 0, 17.57);
    _worksheet_write_sheet_views(worksheet);
...
CTEST(worksheet, write_split_panes06) {
    ...
    lxlsx_worksheet_select(worksheet);
    lxlsx_worksheet_split_panes(worksheet, 0, 45 );
    _worksheet_write_sheet_views(worksheet);
...
CTEST(worksheet, write_split_panes07) {
    ...
    lxlsx_worksheet_select(worksheet);
    lxlsx_worksheet_split_panes(worksheet, 15, 8.43);
    _worksheet_write_sheet_views(worksheet);
